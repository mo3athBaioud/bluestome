...
//	});
	...
	app.data = [
		[1,'系统管理','/page/system/','系统管理',1,1,1,0,'2011-04-01 12:00:00'],
		[2,'菜单管理','/page/system/sysMenu.jsp','菜单管理',1,1,2,1,'2011-04-01 12:00:00'],
		[3,'角色管理','/page/system/sysRole.jsp','角色管理',1,1,3,1,'2011-04-01 12:00:00'],
		[4,'权限管理','/page/system/sysPrivi.jsp','权限管理',1,1,4,1,'2011-04-01 12:00:00'],
		[5,'用户管理','/page/system/sysOperator.jsp','用户管理',1,1,5,1,'2011-04-01 12:00:00']
	];
	
	var ds_sysmenu = new Ext.data.ArrayStore({
        fields: [
		{
			name : 'D_ID',
			type : 'int'
