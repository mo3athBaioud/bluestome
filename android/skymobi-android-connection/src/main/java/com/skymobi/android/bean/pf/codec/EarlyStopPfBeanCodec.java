 ...
 *
 */
public class EarlyStopPfBeanCodec implements BeanFieldCodec {

    private static final Logger logger = 
    	LoggerFactory.getLogger(EarlyStopPfBeanCodec.class);
    ...
    public EarlyStopPfBeanCodec(Field2Desc field2Desc) {
