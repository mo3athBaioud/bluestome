            ...
            if (methods[i].getName().equals(methodName)) {
                ...
                if (methodParamSize == paramSize) {          
                    ...
                    for (int n = 0 ; n < methodParamSize; n++) {
                        if (log.isWarnEnabled()) {
                            log.debug("Param=" + parameterTypes[n].getName());
                            log.debug("Method=" + methodsParams[n].getName());
                        }
                    ...
                    if (match) {
                        ...
                        if (method != null) {
                            if (log.isWarnEnabled()) {
                                log.debug(method + " accessible version of " 
                                            + methods[i]);
                            }
                            setMethodAccessible(method); // Default access superclass workaround
                        ...
                        log.debug("Couldn't find accessible method.");
                    }
                }
            }
        }
