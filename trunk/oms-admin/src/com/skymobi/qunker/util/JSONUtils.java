package com.skymobi.qunker.util;
...
public class JSONUtils {
	...
	public static void sendJsonArray(HttpServletResponse response,
			int totalContent, Collection col) throws IOException {
		String jsonString = collection2Json(col);
		sendJsonString(response, jsonString);
	}

	public static void sendJsonObject(HttpServletResponse response, Object obj)
			throws IOException {
		sendJsonString(response, bean2Json(obj));
	}
	...
	public static void sendJsonString(HttpServletResponse response,
		...
		logger.debug("jsonstring>>>" + string);
