  ...
  Ext.BLANK_IMAGE_URL= './resource/image/ext/s.gif';
            mainTabs = new Ext.TabPanel({
                ...
                items:[{
                      ...
                      listeners: {activate: function(){Ext.getCmp('centerPanel').setTitle('${centerTitle} -> 我的工作台');}},
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"  
	...
	<tr >
		<td style="padding-left:15px"><img class="IEPNG"
			src="./resource/image/eRedG4_Title_2.png" />
		</td>
...
<td width="35%"><div align="right"><nobr>Copyright&copy 2008 eRedLab&reg易道软件实验室 中国.昆明</nobr></div></td>
</tr>
</table>
</div>
