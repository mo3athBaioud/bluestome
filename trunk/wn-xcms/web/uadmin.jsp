...
<html>
    ...
    var node_01010903 = new Ext.tree.TreeNode({
  	...
  	var node_0101090201 = new Ext.tree.TreeNode({
 		...
 		listeners: {
 		'click': function(){
 		  addTab(project+'/pages/admin/staff.jsp','员工管理','0101090201','渭南移动终端业务营销系统 -> 系统管理 -> 员工管理 -> 员工管理','application_view_columns.png');
 		}},
 		expanded:false,
 		iconCls:'icon-application_view_columns',
  	...
  	var node_0101090202 = new Ext.tree.TreeNode({
 		...
 		listeners: {
 		'click': function(){
 		  addTab(project+'/pages/admin/channel.jsp','渠道管理','0101090202','渭南移动终端业务营销系统 -> 系统管理 -> 员工管理 -> 渠道管理','application_view_columns.png');
 		}},
 		expanded:false,
 		iconCls:'icon-application_view_columns',
  	...
  	var node_0101090203 = new Ext.tree.TreeNode({
 		...
 		listeners: {
 		'click': function(){
 		  addTab(project+'/pages/admin/bdistrict.jsp','业务区管理','0101090203','渭南移动终端业务营销系统 -> 系统管理 -> 员工管理 -> 业务区管理','application_view_columns.png');
 		}},
 		expanded:false,
 		iconCls:'icon-application_view_columns',
