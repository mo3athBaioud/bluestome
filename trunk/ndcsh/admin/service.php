...
$intro_rs = $conn->Execute("select * from wdata  where mtype = 'e' and stype = 'a'");

$intro2 = $conn->Execute("select * from wdata  where mtype = 'e' and stype = 'b'");
      ...
      <tr>
		...
		<table width="100%" border="0" align="center">
			  ...
			  <tr>
				...
				<td colspan="3" valign="top"><textarea name="f2" cols="70" rows="6" class="input_t_550" style="display:none"><? echo  html_entity_decode($intro_rs->fields["cdata"], ENT_QUOTES); ?></textarea>
