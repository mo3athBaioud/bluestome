...
$intro2 = $conn->Execute("select * from tbl_ads where d_id = ".$id." and d_status = 1 limit 1");
?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" height="30" valign="middle" bgcolor="#666666"><span class="text16" style="color:#FFFFCC; padding-left:15px;">首页活动广告</span></td>
  </tr>
  <tr>
      ...
      <tr>
		...
		<table width="100%" border="0" align="center">
			  <tr>
				...
				<td colspan="3" valign="top"><input name="title" type="text" size="80" value="<? echo $intro2->fields["d_ads_title"] ?>"  class="input_t_550"/></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td colspan="3" align="center">
				  ...
				  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="800" height="440">
					<? if ($intro2->fields["d_ads_file_name"] != "") {
						echo "<param name=\"movie\" value=\"/upload/".$intro2->fields["d_ads_file_name"] ."\">;";
					 }else{				
						echo "<param name=\"movie\" value=\"/upload/index.swf\">;";
					 }?>
