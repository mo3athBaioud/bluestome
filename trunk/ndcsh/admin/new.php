...
$intro_rs = $conn->Execute("select * from wdata  where mtype = 'd' and stype = 'a' order by ordernum,hotid");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" height="30" valign="middle" bgcolor="#666666"><span class="text16" style="color:#FFFFCC; padding-left:15px;">媒體報導</span></td>
  </tr>
  <tr>
