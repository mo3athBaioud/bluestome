...
$sql="update wdata set hotcaption='".$f1."',".$LANG."data='".$f2."' where hotid='".$k1."'";

	if ($conn->Execute($sql)) {
		$location = "Location:introduction.php?msg=更新完成1";
		header($location);	
		exit;	
	} else {
		$location = "Location:introduction.php?msg=更新失败1";
		header($location);	
		exit;		
	}	
?>