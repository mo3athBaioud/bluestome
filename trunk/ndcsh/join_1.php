...
if(isset($_POST['hotid'])) { $hotid=$_POST['hotid']; }else{ if (isset($_GET['hotid'])) {$hotid=$_GET['hotid'];}}						
	...
	$mrs = $conn->Execute("select * from jobs where hotid='".$hotid."'");
$order   = array("\r\n", "\n", "\r");
$replace = '<br />';		
?>  
...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/01_r2_c8_1.jpg','images/01_r2_c5_1.jpg','images/01_r4_c2_1.jpg','images/01_r3_c2_1.jpg','images/01_r3_c6_1.jpg','images/01_r3_c7_1.jpg','images/01_r3_c9_1.jpg','images/01_r3_c10_1.jpg','images/01_r3_c11_1.jpg','images/72_1.jpg')">
                    ...
                    <table width="776" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr> 
                        <td><table width="776" height="495" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td width="776" valign="top" background="images/73_1.jpg">
<table width="100%" height="103" border="0" cellpadding="0" cellspacing="0" style="z-index:0">
                                  <tr> 
                                    <td height="103" valign="bottom">
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                                        <tr> 
                                          <td width="98%"><div align="right" class="mainContext12"><strong><a href="join.php"><font color="#FFFFFF">&lt; 
                                              GO BACK</font></a></strong></div></td>
                                          <td width="2%">&nbsp;</td>
                                        </tr>
                                      </table>
                                    </td>
                                ...
                                <table width="760" height="21" border="0" cellpadding="0" cellspacing="1">
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td width="87" class="mainContext13"><strong><font color="#000000">招聘职位：</font></strong></td>
                                    <td width="622" class="mainContext13"><strong><font color="720019"><? echo $mrs->fields["f1"]; ?></font></strong> 
                                    </td>
                                  </tr>
                                </table> 
                                <table width="760" height="121" border="0" cellpadding="0" cellspacing="1">
                                  <? if( $mrs->fields["f2"] != "") {?>
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td class="mainContext12"><strong><font color="#000000">职位目的：</font></strong></td>
                                  </tr>
                                  <tr> 
                                    <td height="19">&nbsp;</td>
                                    <td class="mainContext12"><? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f2"], ENT_QUOTES)); ?></td>
                                  </tr>
                                  <?}?>
                                  <? if( $mrs->fields["f3"] != "") {?>
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td class="mainContext12"><strong><font color="#000000">职位要求：</font></strong></td>
                                  </tr>
                                  <tr> 
                                    <td height="19">&nbsp;</td>
                                    <td class="mainContext12">
<? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f3"], ENT_QUOTES)); ?>									
									</td>
                                  </tr>
                                  <?}?>
                                  <? if( $mrs->fields["f4"] != "") {?>
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td class="mainContext12"><strong><font color="#000000">工作职责：</font></strong></td>
                                  </tr>
                                  <tr>
                                    <td height="19">&nbsp;</td>
                                    <td class="mainContext12">
<? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f4"], ENT_QUOTES)); ?>									
									</td>
                                  </tr>
                                  <?}?>
                                </table>
                                ...
                                <? if( $mrs->fields["f5"] != "") {?>
                                  <tr> 
                                    <td width="43">&nbsp;</td>
                                    <td width="70" class="mainContext12"><strong><font color="#000000">薪　
                                      资：</font></strong></td>
                                    <td width="643" class="mainContext12"><? echo $mrs->fields["f5"]; ?></td>
                                  </tr>
                                  <?}?>
                                  <? if( $mrs->fields["f6"] != "") {?>
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td class="mainContext12"><strong><font color="#000000">就职时间：</font></strong></td>
                                    <td class="mainContext12"><? echo $mrs->fields["f6"]; ?></td>
                                  </tr>
                                  <? }?>
                                  <? if( $mrs->fields["f7"] != "") {?>
                                  <tr>
                                    <td width="43" height="19">&nbsp;</td>
                                    <td class="mainContext12"><strong><font color="#000000">上班时间：</font></strong></td>
                                    <td class="mainContext12"><? echo $mrs->fields["f7"]; ?></td>
                                  </tr>
                                  <?}?>
                                </table>
