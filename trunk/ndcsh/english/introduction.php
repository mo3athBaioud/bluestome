<? require_once "conn.php"; 
	$mrs = $conn->Execute("select * from wdata_e where mtype = 'a' and stype = 'a'");
	$dmrs = $conn->Execute("select * from wdata_e where mtype = 'a' and stype = 'b'");	
	$mydata = $LANG."data";
?> 
...
?>		  				  
            ...
            <table width="167" height="84" border="0" cellpadding="0" cellspacing="2">
              <tr> 
                ...
                <td width="149" valign="top" class="mainContext11"><span class="mainContext17"><? echo $mrs->fields["hotcaption"]; ?></span><span class="mainContext12"><br>
                  </span>
				  <div style="overflow:auto;height:200px;">
					<p><? echo html_entity_decode($mrs->fields[$mydata], ENT_QUOTES); ?></p> 
				  </div>
                </td>
              </tr>
            </table> </td>
