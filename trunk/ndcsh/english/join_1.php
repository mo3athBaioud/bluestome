...
if(isset($_POST['hotid'])) { $hotid=$_POST['hotid']; }else{ if (isset($_GET['hotid'])) {$hotid=$_GET['hotid'];}}						
	...
	$mrs = $conn->Execute("select * from jobs_e where hotid='".$hotid."'");
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                                ...
                                <table width="760" height="21" border="0" cellpadding="0" cellspacing="1">
                                  ...
                                  <tr> 
                                    ...
                                    <td width="87" class="mainContext13"><strong><font color="#000000">Vacancies：</font></strong></td>
                                ...
                                <? if( $mrs->fields["f2"] != "") {?>
                                  ...
                                  <tr> 
                                    ...
                                    <td class="mainContext12"><strong><font color="#000000">Job Description：</font></strong></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td class="mainContext12"><strong><font color="#000000">Job Requirements：</font></strong></td>
...
<? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f3"], ENT_QUOTES)); ?>									
                                  ...
                                  <tr> 
                                    ...
                                    <td class="mainContext12"><strong><font color="#000000">Job Responsibilities：</font></strong></td>
...
<? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f4"], ENT_QUOTES)); ?>									
                                ...
                                <? if( $mrs->fields["f5"] != "") {?>
                                  <tr> 
                                    ...
                                    <td width="70" class="mainContext12"><strong><font color="#000000">Salary：</font></strong></td>
                                  ...
                                  <tr> 
                                    ...
                                    <td class="mainContext12"><strong><font color="#000000">Discuss during interview：</font></strong></td>
                                  ...
                                  <tr>
                                    ...
                                    <td class="mainContext12"><strong><font color="#000000">Working Hours：</font></strong></td>
