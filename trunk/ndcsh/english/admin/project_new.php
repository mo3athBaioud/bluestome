<? session_start();
	...
	$intro2 = $conn->Execute("select * from wdata_e  where mtype = 'c' and stype = 'b' order by ordernum,hotid");
	$udate = date("YmdHis");
...
<?	while ($intro2 && !$intro2->EOF) { 	?>
              <tr>
				...
				<a href="project_new.php?hotid=<? echo $intro2->fields["hotid"]; ?>">
				<img src="images/ic_edit.png" width="13" border="0" />
				<span class="text12">Edit</span>
				</a>
				<a href="javascript:main_delete('<? echo $intro2->fields["hotid"]; ?>','project.php');">
