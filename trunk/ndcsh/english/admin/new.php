...
$intro_rs = $conn->Execute("select * from wdata_e  where mtype = 'd' and stype = 'a' order by ordernum,hotid");

$intro2 = $conn->Execute("select * from wdata_e  where mtype = 'd' and stype = 'b' order by ordernum,hotid");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" height="30" valign="middle" bgcolor="#666666"><span class="text16" style="color:#FFFFCC; padding-left:15px;">
	品鉴LUXE</span></td>
  </tr>
  <tr>
	...
	<table width="100%" height="343" border="0"  cellpadding="0" cellspacing="0" style="border:#999999 1px solid">
      ...
      <tr>
        <td height="161" colspan="4" valign="top"><table width="100%" height="139" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="44"></td>
            <td align="center"><a href="new_new.php?id=new" target="_self"><span class="text16">新增一筆</span></a></td>
            </tr>
          <tr>
            <td></td>
            <td valign="top">
