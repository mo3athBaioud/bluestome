<? session_start();
	...
	$intro2 = $conn->Execute("select * from wdata_e  where mtype = 'a' and stype = 'b' order by ordernum,hotid");
	$udate = date("YmdHis");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<form name="mainform" method="post" action="intro_edit1.php" enctype="multipart/form-data">		
			  <tr>
