<? require_once "conn.php"; 
	...
	$mrs = $conn->Execute("select * from wdata where mtype='g' and stype='a' limit 0,1");
                ...
                <td width="508"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="95%"> <div align="right"> 
                          <p class="TopContext"><img src="images/arrow.jpg" width="20" height="20" align="absmiddle"><a href="#">中文</a><img src="images/arrow.jpg" width="20" height="20" align="absmiddle"><a href="english/index.php">English</a></p>
                        </div></td>
                      <td width="5%">&nbsp;</td>
                    </tr>
                  </table></td>
                    ...
                    <tr> 
					  ...
					  <table width="100%" height="281" border="0" cellpadding="0" cellspacing="0" style="z-index:0">
                          ...
                          <table width="760" height="77" border="0" cellpadding="0" cellspacing="2" style="z-index:0">
                            ...
                            <td width="711" valign="top" class="mainContext12"><span class="mainContext12" style="z-index:1"><br>
                                </span><? echo str_replace($order, $replace, html_entity_decode($mrs->fields["f1"], ENT_QUOTES)); ?></td>
                          </tr>
                        </table>
                          <table width="760" height="80" border="0" cellpadding="0" cellspacing="2">
                            <tr> 
                              <td width="44" height="19">&nbsp;</td>
                              <td width="308" class="mainContext12"></td>
                            ...
                            <tr> 
                              ...
                              <td valign="top" class="mainContext12"> <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="z-index:0">
                                  <tr> 
                                    <td width="6%" class="mainContext12"></td>
