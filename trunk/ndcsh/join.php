<? require_once "conn.php"; 
	...
	$mrs = $conn->Execute("select * from jobs");
$order   = array("\r\n", "\n", "\r");
$replace = '<br />';		
?>  
                              ...
                              <td width="776" valign="top" background="images/73.jpg"><table width="100%" height="290" border="0" cellpadding="0" cellspacing="0" style="z-index:0">
                                ...
                                <table width="760" height="34" border="0" cellpadding="0" cellspacing="2" style="z-index:0">
                                  <tr> 
                                    ...
                                    <td width="194" valign="top" class="mainContext12"><span class="mainContext20" style="z-index:1">加入我们 
                                      JOIN US</span></td>
                                    <td width="515" valign="top" class="mainContext12"><span class="mainContext20" style="z-index:1"><font color="720019">~ 
                                      欢迎您加入我们的团队 ~ </font></span></td>
                                  </tr>
                                </table>
                                <table width="760" height="23" border="0" cellpadding="0" cellspacing="2">
                                  <tr> 
                                    <td width="44" height="19">&nbsp;</td>
                                    <td width="308" class="mainContext12"><strong><font color="#000000">招聘职位：</font></strong></td>
...
?>						
                                ...
                                <table width="760" height="23" border="0" cellpadding="0" cellspacing="2">
                                  <tr> 
                                    <td width="43" height="19">&nbsp;</td>
                                    <td width="42" valign="top" class="mainContext12"><strong><font color="#000000">联系：</font></strong></td>
                                    <td width="667" valign="top" class="mainContext12">请将简历寄至<a href="mailto:contact@ndcsh.com"><font color="720019">contact@ndcsh.com</font></a>，邮件请注明应聘职位<br>
                                      我们将尽快安排您面试 </td>
                                  </tr>
                                </table></td>
                            </tr>
