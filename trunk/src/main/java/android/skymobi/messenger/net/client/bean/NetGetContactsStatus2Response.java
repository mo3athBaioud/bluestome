 ...
 */
public class NetGetContactsStatus2Response extends NetResponse {

    private long updateTime;
    private ArrayList<SimpleStatusItem> contactsStatusList = new ArrayList<SimpleStatusItem>();
     ...
     */
    public ArrayList<SimpleStatusItem> getContactsStatusList() {
        return contactsStatusList;
    }
    /**
     * @param contactsStatusList the contactsStatusList to set
     */
    public void setContactsStatusList(ArrayList<SimpleStatusItem> contactsStatusList) {
