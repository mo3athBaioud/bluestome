...
public class PagedStatementSQLServerImpl extends PagedStatement {
     ...
     * @param sql  query sql
     */
    public PagedStatementSQLServerImpl(String sql){
        super(sql);
    }
     ...
     * @param pageNo  页码
     */
    public PagedStatementSQLServerImpl(String sql, int pageNo){
        super(sql, pageNo);
    }
     ...
     * @param pageSize 每页容量
     */
    public PagedStatementSQLServerImpl(String sql, int pageNo, int pageSize){
