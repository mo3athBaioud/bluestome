<? require_once "conn.php"; 
	$mrs = $conn->Execute("select * from wdata_e where mtype = 'f' and stype = 'a'");
	$mydata = $LANG."data";
$order   = array("\r\n", "\n", "\r");
$replace = '<br />';		
?> 
                    ...
                    <table width="776" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr> 
                        <td><table width="776" height="495" border="0" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td width="776" valign="top" background="images/69.jpg"><table width="100%" height="114" border="0" cellpadding="0" cellspacing="0" style="z-index:0">
                                  <tr> 
                                    <td height="114">&nbsp;</td>
                                  </tr>
                                </table> 
                                <table width="100%" height="154" border="0" cellpadding="0" cellspacing="0" style="z-index:0">
                                  <tr> 
                                    <td width="35%" height="154">&nbsp;</td>
                                    <td width="31%" valign="top" class="mainContext12">
									<font color="#FFFFFF">
