  ...
  <tr>
	...
	<form name="mainform" method="post" action="jobs_edit1.php" enctype="multipart/form-data">		
			  ...
			  <tr>
				...
				<td colspan="3" valign="top"><textarea id="f2" name="f2" cols="70" rows="6" class="input_t_550" style="display:none"><? echo html_entity_decode($rs1->fields["f2"], ENT_QUOTES); ?></textarea>
			  ...
			  <tr>
				...
				<td colspan="3" valign="top"><textarea id="f3" name="f3" cols="70" rows="6" class="input_t_550" style="display:none"><? echo html_entity_decode($rs1->fields["f3"], ENT_QUOTES); ?></textarea>
			  ...
			  <tr>
				...
				<td colspan="3" valign="top"><textarea id="f4" name="f4" cols="70" rows="6" class="input_t_550" style="display:none"><? echo html_entity_decode($rs1->fields["f4"], ENT_QUOTES); ?></textarea>
				<iframe id="myEditor3" src="sinaedit/editor.htm?id=f4" frameborder="0" scrolling="no"></iframe></td>
			  </tr>
			  <tr>
