...
<?	while ($intro2 && !$intro2->EOF) { 	?>
              <tr>
                ...
                <td class="td_a" align="center"><a href="project_new.php?hotid=<? echo $intro2->fields["hotid"]; ?>"><img src="images/ic_edit.png" width="13" border="0"/><span class="text12">Edit</span></a>
