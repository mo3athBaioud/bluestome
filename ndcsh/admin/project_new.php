<? session_start();
	...
	$rs3 = $conn->Execute("select * from wdata_pic where hotid='".$hotid."' and udate='".$uudate."' and ordernum = '".$ordernum."'");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" height="30" valign="middle" bgcolor="#666666"><span class="text16" style="color:#FFFFCC; padding-left:15px;">庄园介绍 - <? if ($mcount>0) { echo "修改"; } else { echo "新增"; } ?>項目</span></span></td>
  </tr>
  <tr>
	...
	<form name="mainform" method="post" action="project_edit1.php" enctype="multipart/form-data">		
			  <tr>
			  ...
			  <tr>
				...
				<a name="intro-pic-upload"><span class="text14">上傳的圖檔:&nbsp;</span></a></td>
				...
				<?
						$picrs = $conn->Execute("select * from wdata_pic where hotid = '" .$hotid."' order by ordernum");
					...
					<table width="auto" height="auto" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						<td align="center">
						<a href="project_new.php?hotid=<? echo $hotid; ?>&udate=<? echo $picrs->fields["udate"];?>&ordernum=<?echo $picrs->fields["ordernum"];?>#new-pic-choose">修改</a>
			  ...
			  <tr>
				...
				<input type="hidden" name="url2" value="project_new.php"/>						
				...
				<table width="540" height="81" border="0" style="border:#999999 dotted 1px">
				  ...
				  <tr>
					...
					<td align="right">
						...
						<input type="button" class="button_90"  value="取消" onclick="javascript:location='introduction_new.php?hotid=<?echo $hotid?>'" />
						&nbsp;
					</td>
					<td>&nbsp;</td>
				  </tr>
      ...
      <tr>
        <td height="161" colspan="4" valign="top"><table width="100%" height="139" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="44"></td>
            <td align="center"><a href="project.php?id=new" target="_self"><span class="text16">取消<? if ($mcount>0) { echo "修改"; } else { echo "新增"; } ?></span></a></td>
            </tr>
          <tr>
            <td></td>
            <td valign="top">
...
<?	while ($intro2 && !$intro2->EOF) { 	?>
              <tr>
				...
				<a href="introduction_new.php?hotid=<? echo $intro2->fields["hotid"]; ?>">
