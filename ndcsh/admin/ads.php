...
$id=0;
if(isset($_POST['msg'])) { $msg=$_POST['msg']; }else{ if (isset($_GET['msg'])) {$msg=$_GET['msg'];}}					
$intro_rs = $conn->Execute("select * from tbl_ads where d_ads_title = ".$id);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" height="30" valign="middle" bgcolor="#666666">
		<span class="text16" style="color:#FFFFCC; padding-left:15px;">首页活动广告</span>
	</td>
  </tr>
  <tr>
...
<?	while ($intro2 && !$intro2->EOF) { 	?>
              <tr>
				...
				<a href="ads_edit.php?id=<? echo $intro2->fields["d_id"]; ?>"><img src="images/ic_edit.png" width="13" border="0"/><span class="text12">Edit</span></a>
				<a href="javascript:ads_delete('<? echo $intro2->fields["d_id"]; ?>','delete');">
