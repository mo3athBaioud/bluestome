<? session_start();
	...
	$intro2 = $conn->Execute("select * from wdata  where mtype = 'a' and stype = 'b' order by ordernum,hotid");
	$udate = date("YmdHis");
  ...
  <tr>
	...
	<form name="mainform" method="post" action="club_edit1.php" enctype="multipart/form-data">		
			  ...
			  <tr>
				...
				<?
					...
					<table width="auto" height="auto" border="0" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						<td align="center">
						<a href="introduction_new.php?hotid=<? echo $hotid; ?>&udate=<? echo $picrs->fields["udate"];?>&ordernum=<?echo $picrs->fields["ordernum"];?>#new-pic-choose">修改</a>
			  ...
			  <tr>
				...
				<input type="hidden" name="url2" value="introduction_new.php"/>						
