...
$url2 = "project_new.php?hotid=".$hotid;	

$sg = "修改";
} else {

$sql="insert into wdata (hotid,hotcaption,".$LANG.
		"data,optid,mtype,stype,udate,background,picture,subcaption,piccaption) values".
		" ('$hotid','$f1','$f2','".$_SESSION['manager']."','c','b','$udate','$jp','$jp2','$f3','$f4')";
$url2 = "project_new.php?hotid=".$hotid;		
$sg = "新增";
}
	if ($conn->Execute($sql)) {
