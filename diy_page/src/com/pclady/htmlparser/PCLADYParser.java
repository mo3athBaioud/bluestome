...
public class PCLADYParser {

	static String URL = "http://photo.pclady.com.cn/";
	...
	static void catalog(String url) throws Exception { // WebsiteBean bean
		...
		NodeList list = parser.extractAllNodesThatMatch(fileter).extractAllNodesThatMatch(new HasAttributeFilter("class", "dNav"));
