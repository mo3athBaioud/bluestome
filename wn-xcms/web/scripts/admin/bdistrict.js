...
Ext.onReady(function(){
    ...
    **/
    ...
    app.cm_data = new Ext.grid.ColumnModel([
        ...
        {header: "所属业务区", width: 100, sortable: true, dataIndex: 'parentcode'},
...
//		disabled:true,
	...
	app.grid = new Ext.grid.GridPanel({
        ...
        autoScroll: true,
		sm:app.sm,
		tbar : [app.btn_detail,'-',app.btn_add,'-',app.btn_disable,'-',app.btn_enable,'-','请输入业务区名称:',app.text_search_code,'-',app.btn_search_code],
		bbar : app.ptb
	});
