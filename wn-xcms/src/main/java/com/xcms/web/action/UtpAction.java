...
public class UtpAction extends BaseAction{
	...
	@At("/gprs")
	@Ok("json")
	public JsonObject gprs(@Param("bdcode") String bdcode,@Param("phonenum") String phonenum,@Param("loginname") String loginname,@Param("start") int start,@Param("limit") int limit,HttpServletRequest request){
