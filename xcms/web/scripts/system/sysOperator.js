...
//					searchoperator();
	...
	var update_operator_btn = new Ext.Button({  
	 ...
	 var windows_add_operator = new Ext.Window({
	 	...
	 	title:'<img src="../../images/user_add.png" align="top" class="IEPNG">添加',
		width : 350,
		height : 440,
		resizable : false,
		autoHeight : true,
...
//	ds_sysOperator.loadData(data);
	...
	var grid_operator = new Ext.grid.GridPanel({
		title : '<img src="../../images/user.png" align="top" class="IEPNG"><span style="font-weight:normal">操作员管理</span>',
//		width : 800,
//		autoHeight : true,
		height:500,
		autoScroll : true,
