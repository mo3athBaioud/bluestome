...
<HTML>
	...
	function back2index(){
 	...
 	function  fresh(){ 
		window.location= "${ctx}/articleDoc.cgi"; 
	}
	...
	<BODY>
		<!-- onload="timer()" -->
		<CENTER>
			<FORM name=form1 action="${ctx}/articleDoc.cgi" method="post"
							...
							<c:choose>
								<c:when test="${isOk == 'ok'}">
									...
									<script type="text/javascript">
								        ...
								        so.addVariable("chart_settings", encodeURIComponent("<settings><background><color>#FFFFFF,#FF9E01</color><alpha>100</alpha></background><labels><label><y>24</y><width>520</width><align>center</align><text><![CDATA[<b>SSIIT文章统计</b>]]></text></label></labels></settings>"));
