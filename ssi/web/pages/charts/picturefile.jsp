...
<HTML>
	...
	<BODY> <!-- onload="timer()" -->
		<CENTER>
			<FORM name=form1 action="${ctx}/picturefile.cgi" method="post" onSubmit="return formSubmit(this);">
							...
							<c:choose>
								<c:when test="${isOk == 'ok'}">
									...
									<script type="text/javascript">
								        ...
								        so.addVariable("chart_settings", encodeURIComponent("<settings><background><color>#FFFFFF,#FF9E01</color><alpha>100</alpha></background><labels><label><y>24</y><width>520</width><align>center</align><text><![CDATA[<b>SSI图片文章统计</b>]]></text></label></labels></settings>"));
									...
									<p align="center">
										...
										<input type="button" value="返回" onclick="back2index();" class="button">
									</p>
								</c:when>
								<c:otherwise>
