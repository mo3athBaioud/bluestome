  ...
  public String getSmsInfos(String encoded) {
    try {
      ...
      /* 内容编码2.0 */
        ...
        appid = String.valueOf(toInt(tmp.toCharArray()));
        // VMVer
        pos += 4;
        tmp = new String(a, pos, 4);
        vmver = String.valueOf(toInt(tmp.toCharArray()));
        // HSVer
        pos += 4;
        tmp = new String(a, pos, 4);
        hsver = String.valueOf(toInt(tmp.toCharArray()));
        // MessageNum
        pos += 4;
        new String();
      ...
      /* 内容编码2.1 */
        ...
        vmver = String.valueOf(toShort(tmp.toCharArray()));
        // HSVer
        pos += 2;
        tmp = new String(a, pos, 4);
        hsver = String.valueOf(toInt(tmp.toCharArray()));
