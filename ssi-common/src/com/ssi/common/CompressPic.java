 ...
 */
 public class CompressPic { 
 	...
 	public static void main(String[] arg) { 
 		...
 		System.out.println("输入的图片大小：" + mypic.getPicSize("D:\\TMP\\test\\in\\43502_1.jpg")/1024 + "KB"); 
 		int count = 0; // 记录全部图片压缩所用时间
 		for (int i = 0; i < 1; i++) { 
 			int start = (int) System.currentTimeMillis();	// 开始时间 
 			mypic.compressPic("D:\\TMP\\test\\in\\", "D:\\TMP\\test\\out\\", "43502_1.jpg", "r1"+i+".jpg", 140, 105, true); 
